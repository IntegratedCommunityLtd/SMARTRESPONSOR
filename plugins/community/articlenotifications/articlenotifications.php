	...
	class plgCommunityArticleNotifications extends CApplications
	{
        ...
        public function onLoadingExtraNotifications($data){
            ...
            $data = array_merge(array(
                array('OTHERS', 'article_comment', 'Article comments & replies', 'On-site and Email notification when someone replies on my comment'),
                array('OTHERS', 'article_comment_like', 'Article comment likes', ' On-site and email notification when someone likes my comment')
            ), $data);
