...
//                        $remainingUploadCount = $max - $total;
    ...
    public function ajaxStreamRemoveComment($wallid) {
        ...
        if (COwnerHelper::isCommunityAdmin() || $table->post_by == $my->id || $contenOwner) {
            ...
            if (!empty($wallParam->get('notificationId', ''))) {
            ...
            if ($wallParam->get('activityId', 0) > 0) {
                ...
                $streamTable->load($wallParam->get('activityId'));
                $streamTable->delete();
                $streamTable->reset();
            }
