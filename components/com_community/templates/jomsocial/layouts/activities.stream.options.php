...
<div class="joms-list__options">
    ...
    <ul class="joms-dropdown">
        ...
        <?php if (COwnerHelper::isCommunityAdmin() && ($act->actor != $my->id) && !COwnerHelper::isCommunityAdmin($act->actor)) { ?>
        <li>
            <a href="javascript:" onclick="joms.api.userBan('<?php echo $act->actor; ?>');">
                <?php echo JText::sprintf('COM_COMMUNITY_BAN_USER_DISPLAYNAME',CFactory::getUser($activity->actor)->getDisplayName()); ?>
            </a>
        </li>
        <?php } ?>
