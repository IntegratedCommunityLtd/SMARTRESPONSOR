        ...
        action: {
                        ...
                        criteria +='<select name="field'+keynum+'" id="field'+keynum+'" onchange="jsAdvanceSearch.action.changeField(\''+keynum+'\');" class="joms-input">';
                            ...
                            ?>
                                    criteria +='<optgroup label="<?php echo addslashes( JText::_($label) );?>">';
                                        ...
                                        ?>
                                                criteria +='<option value="<?php echo addslashes($field->fieldcode); ?>" <?php echo $selected; ?> <?php echo $html_data; ?>><?php echo (isset($params) && $params->get('display', 0) == 'age' && $field->type == 'birthdate') ? JText::_("COM_COMMUNITY_AGE") : JText::_(addslashes(JString::trim($field->name)));?></option>';
                                        <?php
                                            }
                                        }
                                        ?>
            ...
            addAltInputField: function(type, id) {
                ...
                if ( cond === 'between' ) {
                    ...
                    inputField = '<span class="joms-input" style="display:inline;border:0 none"> and </span>' + inputField;
                } else {
                    inputField = '';
                }
            ...
            toggleAgeSearch: function(id,mode) {
                ...
                if(mode == 1){
                    ...
                    joms.jQuery('#valueinput'+id).html(inputField);
                    if(cond == "between"){
                        inputField = '<span class="joms-input" style="display:inline;border:0 none"> and </span><input type="text" name="value'+id+'_2" id="value'+id+'_2" class="joms-input" value="" />';
                        joms.jQuery('#valueinput'+id+'_2').html(inputField);
                    }
                } else {
