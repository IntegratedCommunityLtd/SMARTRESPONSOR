...
class AltauserpointsControllerInvite extends JControllerForm
{
	...
	public function sendinvite () 
	{
		...
		if ($validate === false)
		{
			...
			$this->setRedirect(JRoute::_('index.php?option=com_altauserpoints&view=invite&Itemid='.$app->input->getInt('Itemid'), false ));
			return false;
		}
		...
		$this->setRedirect('index.php?option=com_altauserpoints&view=invite&Itemid='.$app->input->get('Itemid', ''));
		$this->redirect();        		
