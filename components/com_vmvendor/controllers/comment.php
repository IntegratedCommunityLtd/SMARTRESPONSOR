 ...
 */
class VmvendorControllerComment extends VmvendorController {	
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Comment', 'VmvendorModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_vmvendor') || $user->authorise('core.edit.state', 'com_vmvendor')) {
            $model = $this->getModel('Comment', 'VmvendorModel');
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_vmvendor&view=comments', false));
            } else {
    ...
    public function remove() {
        ...
        //Checking if the user can remove object
        $user = JFactory::getUser();
        if ($user->authorise($user->authorise('core.delete', 'com_vmvendor'))) {
            $model = $this->getModel('Comment', 'VmvendorModel');
