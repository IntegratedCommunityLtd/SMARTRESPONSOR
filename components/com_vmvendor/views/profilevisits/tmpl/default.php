...
echo  '<h1><i class="vmv-icon-calendar"></i> '.JText::_('COM_VMVENDOR_PROFILEVISITS').'</h1>';
...
echo  '<hr />
	<h1><i class="vmv-icon-users"></i> '.JText::_('COM_VMVENDOR_PROFILEVISITS_LATESTVISITORS').'</h1>';
if($profileman=='js')
{
