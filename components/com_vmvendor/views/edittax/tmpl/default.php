...
?>
    <form  method="post" name="adminForm" id="adminForm"  class="vmv-form form-validate form-horizontal"  action="<?php echo JRoute::_('index.php?option=com_vmvendor&view=edittax&Itemid='.$app->input->get('Itemid') ) ?>" >
