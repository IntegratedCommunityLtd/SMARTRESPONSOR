...
$virtuemart_vendor_id = $this->virtuemart_vendor_id;
	...
	?>
    <form  method="post" name="adminForm" id="adminForm"  class="vmv-form form-validate"  action="<?php echo JRoute::_('index.php?option=com_vmvendor&view=editshipment&Itemid='.$app->input->get('Itemid') ) ?>" >
