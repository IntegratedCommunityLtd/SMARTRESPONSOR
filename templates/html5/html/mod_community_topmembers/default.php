...
<div class="joms-module--topmembers">
 <?php if ( !empty($users) ) { ?>
 <div id="js-masonry" class="view">
	<?php foreach ($users as $user) { ?>
	<div id="products" class="browse">
		...
		<div>  
			...
			<img src="<?php echo $user->avatar; ?>"
                            ...
                            data-author="<?php echo $user->id; ?>" class="img-responsive">
			
		</div>
	</div>
 <?php } }else { ?>
 <div class="joms-blankslate"><?php echo JText::_('MOD_COMMUNITY_TOPMEMBERS_NO_MEMBERS'); ?></div> <?php } ?>
