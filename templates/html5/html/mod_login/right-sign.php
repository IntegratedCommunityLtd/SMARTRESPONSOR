...
<form role="form" action="<?php echo JRoute::_(htmlspecialchars(JUri::getInstance()->toString()), true, $params->get('usesecure')); ?>" method="post" id="member-login" class="form-validate" style="font-size: 50%; padding:0px;">
	...
	<?php endif; ?>
			...
			<div class="btn-margin-top">
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=registration&Itemid=' . UsersHelperRoute::getRegistrationRoute()); ?>" class="btn btn-link reset">
				<?php echo JText::_('MOD_LOGIN_REGISTER'); ?></a><span>   &nbsp </span>
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=remind&Itemid=' . UsersHelperRoute::getRemindRoute()); ?>" class="btn btn-link reset"><?php echo JText::_('MOD_LOGIN_FORGOT_YOUR_USERNAME'); ?></a> <span>    </span>
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=reset&Itemid=' . UsersHelperRoute::getResetRoute()); ?>" class="btn btn-link reset"><?php echo JText::_('MOD_LOGIN_FORGOT_YOUR_PASSWORD'); ?></a>
