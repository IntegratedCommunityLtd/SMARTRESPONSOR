...
<form action="<?php echo JRoute::_('index.php?'.$this->url->getQuery()); ?>" method="post" name="adminForm">
    ...
    <input type="button" class="col-xs-12 btn btn-primary button" onclick="SmFaq.submitform('save', this.form);" value="<?php echo JText::_('COM_SMFAQ_SAVE'); ?>" />
	<div class="col-xs-12"> &nbsp; </div>
	<input type="button" class="col-xs-12 btn btn-primary button" onclick="SmFaq.submitform('cancel', this.form);" value="<?php echo JText::_('COM_SMFAQ_CLOSE'); ?>" />
	<div class="col-xs-12"> &nbsp; </div>
    <?php if ($this->form->getValue('id')) : ?>
	    <fieldset>
