...
<?php endif; ?>
<?php elseif ($canEdit) : ?>
	<a href="<?php echo JRoute::_('index.php?option=com_smfaq&amp;task=edit.add&amp;catid='.$this->category->id); ?>" class="btn btn-primary">
...
<?php foreach ($this->items as $item) : ?>
           ...
           <?php 
            ...
            <?php if ($canEdit) : ?> 
            	<div class="clr"></div>
				<a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_smfaq&task=edit.edit&catid='.$item->catid.'&id='.$item->id); ?>"><?php echo JText::_('COM_SMFAQ_EDIT'); ?></a>
