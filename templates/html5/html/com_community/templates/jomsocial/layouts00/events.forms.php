...
<div class="joms-page">
    ...
    <form method="POST" action="<?php echo CRoute::getURI(); ?>" onsubmit="return joms_validate_form( this );">
        ...
        <div class="joms-form__group">
            ...
            <input type="submit" value="<?php echo JText::_($event->id ? 'COM_COMMUNITY_SAVE_BUTTON' : 'COM_COMMUNITY_EVENTS_CREATE_BUTTON'); ?>" class="joms-button--primary joms-button--full-small">
        </div>
