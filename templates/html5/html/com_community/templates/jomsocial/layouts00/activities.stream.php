...
<div class="joms-stream__header">
    <div class= "joms-avatar--stream">
        <img src="components/com_community/assets/user-Male-thumb.png"/ alt="<?php echo JText::_('COM_COMMUNITY_MALE'); ?>" >
    </div>
                        ...
                        <?php
                            ...
                            if (count($attachment->thumbnail) >= 5) {
                                ...
                                <div class="joms-stream-multi-photo-hero">
                                    <a href="#">
                                        <img src="<?php echo $attachment->thumbnail[0]; ?>" alt="" />
                                    </a>
                                </div>
                ...
                <div class="cStream-Attachment">
                    <div class="joms-stream-single-photo">
                        <a href="<?php echo $attachment->link; ?>">
                            <img src="<?php echo $attachment->singlephoto; ?>" alt="" />
                        </a>
