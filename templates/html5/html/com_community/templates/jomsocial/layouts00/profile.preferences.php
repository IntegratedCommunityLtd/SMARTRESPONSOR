...
<script>
    ...
    function joms_preferences_changetab( id ) {
        ...
        labels = {
            general    : '<?php echo JText::_("COM_COMMUNITY_PROFILE_PREFERENCES_GENERAL"); ?>',
            privacy    : '<?php echo JText::_("COM_COMMUNITY_PROFILE_PREFERENCES_PRIVACY"); ?>',
            email      : '<?php echo JText::_("COM_COMMUNITY_PROFILE_PREFERENCES_EMAIL"); ?>',
            ignorelist : '<?php echo JText::_("COM_COMMUNITY_PROFILE_PREFERENCES_BLOCKIGNORELIST"); ?>'
        };
