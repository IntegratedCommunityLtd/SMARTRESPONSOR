...
<div class="joms-page">
    <div class="joms-list__search">
        <span>
            <h3 class="joms-page__title"><?php echo $video->title; ?></h3>
        </span>
        ...
        <div class="joms-list__utilities">
            ...
            <button onclick="joms.api.videoAdd('<?php echo $isGroup ? $groupId : '' ?>');" class="joms-button--add">
                <span><?php echo ( !$isGroup ) ? JText::_('COM_COMMUNITY_VIDEOS_ADD') : JText::_('COM_COMMUNITY_GROUP_VIDEOS_ADD'); ?></span>
    ...
    <button class="joms-button--neutral joms-button--small" onclick="joms.api.pageShare('<?php echo $video->path; ?>')"><?php echo JText::_('COM_COMMUNITY_SHARE'); ?></button>
    <?php } ?>
...
<script>
    (function( w ) {
        ...
        function tagStart() {
            ...
            joms.util.videotag.create( joms.jQuery('.cVideo-Wrapper iframe,.cVideo-Wrapper video,.cVideo-Wrapper .joms-js--video').eq(0), indices );
