...
<div class="joms-comment__item joms-js--comment joms-js--comment-<?php echo $wall->id; ?>" data-id="<?php echo $wall->id; ?>" data-parent="<?php echo $wall->contentid; ?>">
            ...
            <?php if (!empty($photoThumbnail)) { ?>
                <div style="padding: 5px 0">
                    <a href="javascript:" onclick="joms.api.photoZoom('<?php echo $photoThumbnail; ?>');">
                        <img class="joms-stream-thumb" src="<?php echo $photoThumbnail; ?>" alt="" />
                    </a>
                </div>
            <?php } else {
                if ($paramsHTML) { ?>
