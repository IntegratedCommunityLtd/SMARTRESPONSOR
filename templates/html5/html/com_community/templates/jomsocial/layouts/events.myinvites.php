			...
			<li class="joms-list__item" id="events-invite-<?php echo $event->id;?>">
				<div class="joms-list__cover">
					<a href="<?php echo CRoute::_( 'index.php?option=com_community&view=events&task=viewevent&eventid=' . $event->id );?>" />
						<div class="joms-list__cover-image" style="background:url(<?php echo $event->getCover(); ?>) no-repeat center center;"></div>
					</a>
				</div>
				<div class="joms-padding">
					...
					<ul class="joms-list--table">
                        ...
                        <li>
                            <svg class="joms-icon" viewBox="0 0 16 16">
                                <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-location"/>
                            </svg>
                        ...
                        <li>
                        	<div class="joms-gap"></div>
                            <svg class="joms-icon" viewBox="0 0 16 16">
                                <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-clock"/>
                            </svg>
                        	<small><?php echo JText::sprintf('COM_COMMUNITY_EVENTS_DURATION', JHTML::_('date', $event->startdate, JText::_('DATE_FORMAT_LC2')), JHTML::_('date', $event->enddate, JText::_('DATE_FORMAT_LC2'))); ?></small>
                        </li>
					</ul>
                ...
                <div class="joms-list__permission joms-js--invitation-buttons-event-<?php echo $event->id; ?> top-gap" style="white-space:nowrap">
                    <button class="joms-button--neutral joms-button--small" onclick="joms.api.invitationReject('event', '<?php echo $event->id; ?>');"><?php echo JText::_('COM_COMMUNITY_EVENTS_REJECT'); ?></button>
                    <button class="joms-button--primary joms-button--small" onclick="joms.api.invitationAccept('event', '<?php echo $event->id; ?>');"><?php echo JText::_('COM_COMMUNITY_EVENTS_ACCEPT'); ?></button>
                </div>
			</li>
		<?php } ?>
		</ul>
