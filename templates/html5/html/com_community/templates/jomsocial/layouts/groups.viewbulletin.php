...
?>
<div class="joms-page">
    <h3 class="joms-page__title"><?php echo $bulletin->title; ?></h3>
    <?php if($canCreate) { ?>
    <button class="joms-button--add-on-page joms-button--primary joms-button--small" onclick="window.location='<?php echo CRoute::_('index.php?option=com_community&view=groups&groupid=' . $group->id . '&task=addnews'); ?>';"><?php echo JText::_('COM_COMMUNITY_CREATE_GROUP_ANNOUNCEMENT') ?></button>
    <?php } ?>
    <?php echo $submenu;?>
</div>
...
<div class="joms-main">
    <div class="joms-page">
        ...
        <div class="joms-comment joms-comment--bulletin">
            <div class="joms-comment__header">
                <div class="joms-avatar--comment">
                    ...
                    <a class="joms-avatar" href="<?php echo CUrlHelper::userLink($creator->id); ?>">
                        <img src="<?php echo $creator->getThumbAvatar(); ?>" border="0" alt="" />
                    </a>
                </div>
            ...
            <div class="joms-js--announcement-edit-<?php echo $bulletin->groupid ?>-<?php echo $bulletin->id ?>" style="display:none;">
                <form method="POST" action="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=editnews'); ?>">
                    ...
                    <div class="joms-form__group">
                        ...
                        <textarea name="message" class="joms-textarea" data-wysiwyg="trumbowyg"><?php echo $editorMessage; ?></textarea>
                    </div>
