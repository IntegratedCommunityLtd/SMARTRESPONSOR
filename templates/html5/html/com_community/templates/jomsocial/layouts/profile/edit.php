...
<div class="joms-page">
    ...
    <ul class="nav nav-tabs hidden-xs">
        <li class="active"><a href="#information"
           class="active" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_PROFILE_SETTING_INFO'); ?></a></li>
        <li><a href="#account" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_PROFILE_SETTING_ACCOUNT'); ?></a></li>
    </ul>
