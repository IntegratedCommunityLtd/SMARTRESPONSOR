...
<div class="joms-page">
    ...
    <div class="joms-js--photo-ct" style="position:relative; height:404px; line-height:400px; text-align:center; background: rgba(0,0,0,1);">
        <button title="Prev" type="button" class="mfp-arrow mfp-arrow-left joms-js--btn-prev" style="display:none"></button>
...
<script>
    (function( w ) {
        ...
        function init() {
            ...
            joms.ajax({
                ...
                callback: function( json ) {
                    ...
                    joms.jQuery('.joms-js--photo-comment').on( 'click', '.joms-js--more-comments', fetchAllComments );
        ...
        function tagStart( e ) {
            ...
            joms.util.phototag.create( e, indices, 'page' );
