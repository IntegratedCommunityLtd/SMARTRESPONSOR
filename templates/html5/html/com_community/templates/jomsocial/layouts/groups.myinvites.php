...
<div class="joms-page">
    <div class="joms-list__search">
        ...
        <div class="joms-list__utilities">
            ...
            <!--<?php if($canCreate) { ?>
            <button onclick="joms.api.videoAdd('<?php echo $isGroup ? $groupId : '' ?>');" class="joms-button--primary"><?php echo ( !$isGroup ) ? JText::_('COM_COMMUNITY_VIDEOS_ADD') : JText::_('COM_COMMUNITY_GROUP_VIDEOS_ADD'); ?></button>
            <?php } ?>-->
        </div>
    </div>
    ...
    ?>
        <li id="groups-invite-<?php echo $group->id;?>" class="joms-list__item">
            ...
            <div class="joms-list__footer joms-padding">
                <a class="joms-avatar" href="<?php echo CUrlHelper::userLink($creator->id);?>"><img src="<?php echo $creator->getAvatar();?>" alt="" ></a>
