...
<div class="joms-page">
    ...
    <div class="joms-tab__bar">
        ...
        <a href="<?php echo CRoute::_('index.php?option=com_community&view=friends&userid='.$userid.'&task=mutualfriends'); ?>" class="<?php echo ($currentTask == 'mutualfriends') ? 'active' : ''; ?>"><?php echo JText::_('COM_COMMUNITY_MUTUAL'); ?></a>
        <?php } ?>
    </div>
    <?php } ?>
