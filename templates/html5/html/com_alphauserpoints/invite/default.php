...
if ( $this->displ=='view' ) {
	...
	<?php endif; ?>
	<div id="invite-form">
		<form action="<?php echo JRoute::_( 'index.php?Itemid='.JFactory::getApplication()->input->get('Itemid', '') );?>" method="post" name="inviteForm" id="inviteForm" role="form" class="form-validate">
		<fieldset>
		...
		<div class="form-group input-group">
			...
			<span id="jform_other_recipients-lbl" for="other_recipients" class="input-group-addon hasTooltip required hidden-xs" data-title="<strong><?php echo JText::_( 'JGLOBAL_EMAIL' ); ?></strong>" data-toggle="popover" data-content="<?php echo JText::_( 'AUP_SEPERATEMULTIPLEEMAIL' ); ?>"><?php echo JText::_( 'JGLOBAL_EMAIL' ); ?><span class="star">&nbsp;*</span></span>


				<input type="text" name="other_recipients" id="other_recipients" class="form-control validate-email" required="" aria-required="true" placeholder="<?php echo JText::_( 'JGLOBAL_EMAIL' ); ?>"/>

		</div>
		<div class="form-group input-group">
	
			<span id="jform_sender-lbl" for="sender" class="input-group-addon hasTooltip required hidden-xs" data-title="<strong><?php echo JText::_( 'AUP_YOURNAME' ); ?></strong>" data-toggle="popover" data-content="<?php echo JText::_( 'AUP_YOURNAME' ). ' ('.JText::_( 'AUP_REQUIRED' ).')'; ?>"><?php echo JText::_( 'AUP_YOURNAME' ); ?><span class="star">&nbsp;*</span></span>


				<input type="text" name="sender" id="sender" value="<?php echo $this->user_name; ?>"  class="form-control validate-username" required="" aria-required="true" placeholder="<?php echo JText::_( 'AUP_YOURNAME' ); ?>" />

		</div>
		<div class="form-group input-group">
		
			<span id="jform_custommessage-lbl" for="custommessage" class="input-group-addon hasTooltip hidden-xs" data-title="<strong><?php echo JText::_( 'AUP_CUSTOMMESSAGEOPTIONAL' ); ?></strong>" data-toggle="popover" data-content="<?php echo JText::_( 'AUP_THISMESSAGEWILLBEAPPEARINTHEEMAILSENT' ); ?>"><?php echo JText::_( 'AUP_CUSTOMMESSAGEOPTIONAL' ); ?></span>


				<textarea class="inputbox form-control" rows="4" name="custommessage" id="custommessage"></textarea>
		...
		<input type="text" name="referrer_link" id="referrer_link" onfocus="select();" readonly="readonly" class="form-control inputbox" value="<?php echo $this->referrer_link; ?>" />
		<p>&nbsp;</p>
		...
		<div class="form-actions">
			...
			<?php /* ?><a class="btn" href="<?php echo JRoute::_('');?>" title="<?php echo JText::_('JCANCEL');?>"><?php echo JText::_('JCANCEL');?></a><?php */?>
		</div>			
		<?php } ?>
