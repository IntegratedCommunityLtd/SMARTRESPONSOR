...
<?php endif; ?>
<form action="<?php echo JFilterOutput::ampReplace($this->action); ?>" method="post" role="form" name="adminForm" class="form-inline">
...
?>
	...
	<table class="category table table-striped table-bordered table-hover userlist">
		<thead>
				...
				<?php
					...
					if ( $this->useAvatarFrom ) {
						...
						if ( $this->params->get( 'show_links_to_users', 1) && $user->id || $this->params->get( 'show_links_to_users', 1) && !$user->id && $this->allowGuestUserViewProfil ){
							$startprofil =  '<a href="' . $linktoprofil . '" class="">';
							$endprofil   = '</a>';
						}					
