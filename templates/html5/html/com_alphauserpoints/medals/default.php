...
<?php endif; ?>
	...
	<table class="category table table-responsive table-striped table-hover rewards table-padding">
		<thead>
			<tr>
		...
		<?php	
			...
			<tr class="cat-list-row<?php echo $i % 2; ?>">
				...
				<td headers="categorylist_header_title" class="list-title"><p>
