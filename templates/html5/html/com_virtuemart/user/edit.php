...
<form method="post" id="adminForm" name="userForm" role="form" action="<?php if ($key != 12) { echo JRoute::_('index.php?view=user',$this->useXHTML,$this->useSSL); } ?>" class="form-validate">
