...
<!-- 	<div class="<?php //echo $class?>"> -->
		...
		if($customTitle and isset($product->customfieldsSorted[$position][0])){
			...
			?>
<div class="form-group product-fields-title-wrapper">
	<label class="control-label"><?php echo vmText::_ ($field->custom_title) ?></label>
			<?php
			if ($field->custom_tip) {
		...
		foreach ($product->customfieldsSorted[$position] as $field) {
			...
			continue;
			?>
	<label class="control-label"><?php echo vmText::_ ($field->custom_title) ?><span class="product-fields-title"></label>
			<?php
