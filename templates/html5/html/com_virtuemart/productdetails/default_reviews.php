			...
			foreach ($this->rating_reviews as $review) {
				...
				if (!empty($this->rating_reviews) && $review->published) {
					...
					<div class="<?php echo $color ?>">
						<h3 class="title"><?php echo $review->customer ?></h3>
	...
	if ($this->allowReview) {
		...
		<div class="write-reviews">
            ...
            jQuery(function($) {
               ...
               var boxWidth = 70;// nbr of total pixels
               var starSize = 14;
               var ratingboxPos= $('.write-reviews .ratingbox').offset();

               $('.write-reviews .ratingbox').mousemove( function(e){
                  var span = $(this).children();
                  var dif = e.pageX-(ratingboxPos.left+760); // nbr of pixels
         ...
         $document->addScriptDeclaration($reviewJavascript);
			...
			if ($this->showRating) {
				if ($this->allowRating && $review_editable) {
					...
					<strong ><?php echo JText::_ ('COM_VIRTUEMART_RATING_FIRST_RATE') ?></strong>
					<div class="rating">
			...
			if ($review_editable) {
				...
				<div>
					<p><?php echo JText::_ ('COM_VIRTUEMART_REVIEW_COUNT') ?></p>
