	...
	<?php if ( ($this->referreid==@$_SESSION['referrerid']) && ($user->id==$this->userinfo->userid) && ($this->params->get( 'show_tab_profile')) ) { ?>
		...
		<form action="<?php echo JRoute::_( 'index.php' );?>" method="post" name="frmProfile" id="frmProfile" class="form-validate">
			<table class="category table table-striped table-bordered table-hover">
			  ...
			  <tr> 
				<td><label for="aboutme"><?php echo  JText::_('AUP_ABOUT_ME') ; ?></label></td>
			  ...
			  <tr> 
				...
				<td>
                  <input name="phonemobile" type="text" id="phonemobile" class="form-control inputbox" value="<?php echo $this->user_info->phonemobile; ?>" size="35" /></td>				
			  </tr>
			  <tr> 
				<td><?php echo  JText::_('AUP_HOME_PHONE') ; ?></td>
				<td>
                  <input name="phonehome" type="text" id="phonehome" class="form-control inputbox" value="<?php echo $this->user_info->phonehome; ?>" size="35" /></td>				
			  </tr>
			  <tr> 
				<td><?php echo  JText::_('AUP_ADDRESS') ; ?></td>
				<td>
                  <input name="address" type="text" id="address" class="form-control inputbox" value="<?php echo $this->user_info->address; ?>" size="35" /></td>				
			  </tr>
			  <tr>
                <td><?php echo  JText::_('AUP_ZIPCODE') ; ?></td>
                <td><input name="zipcode" type="text" id="zipcode" class="form-control inputbox" value="<?php echo $this->user_info->zipcode; ?>" size="6" /></td>
		      </tr>
			  <tr>
                <td><?php echo  JText::_('AUP_CITY') ; ?></td>
                <td><input name="city" type="text" id="city" class="form-control inputbox" value="<?php echo $this->user_info->city; ?>" size="35" /></td>
		      </tr>
			  <tr>
			  ...
			  <tr> 
				...
				<td>
                  <input name="website" type="text" id="website" class="form-control inputbox" value="<?php echo $this->user_info->website; ?>" size="35" /></td>				
			  </tr>
			  <?php } ?>
			  <?php
				// contact information
			  ...
			  <tr>
                ...
                <td><input name="education" type="text" id="education" class="form-control inputbox" value="<?php echo $this->user_info->education; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo  JText::_('AUP_CLASS_YEAR') ; ?></td>
                <td><input name="graduationyear" type="text" class="form-control inputbox" id="graduationyear" value="<?php echo $this->user_info->graduationyear; ?>" size="6" maxlength="4" /></td>
		      </tr>
			  <tr>
                <td><?php echo  JText::_('AUP_JOB_TITLE') ; ?></td>
                <td><input name="job" type="text" id="job" class="form-control inputbox" value="<?php echo $this->user_info->job; ?>" size="35" /></td>
		      </tr>
			  <?php } ?>
			  <?php
				// contact information
			  ...
			  <tr>
                ...
                <td><input name="facebook" type="text" id="facebook" class="form-control inputbox" value="<?php echo $this->user_info->facebook; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo '<img src="' . _AUP_IMAGE_LIVE_PATH . 'twitter.gif" border="0" alt="Twitter" title="Twitter" />' ; ?></td>
                <td><input name="twitter" type="text" id="twitter" class="form-control inputbox" value="<?php echo $this->user_info->twitter; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo '<img src="' . _AUP_IMAGE_LIVE_PATH . 'icq.gif" border="0" alt="icq" title="icq" />' ; ?></td>
                <td><input name="icq" type="text" id="icq" class="form-control inputbox" value="<?php echo $this->user_info->icq; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo '<img src="' . _AUP_IMAGE_LIVE_PATH . 'aim.gif" border="0" alt="AOL" title="AOL" />' ; ?></td>
                <td><input name="aim" type="text" id="aim" class="form-control inputbox" value="<?php echo $this->user_info->aim; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo '<img src="' . _AUP_IMAGE_LIVE_PATH . 'yim.gif" border="0" alt="Yahoo" title="Yahoo" />' ; ?></td>
                <td><input name="yim" type="text" id="yim" class="form-control inputbox" value="<?php echo $this->user_info->yim; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo '<img src="' . _AUP_IMAGE_LIVE_PATH . 'msn.gif" border="0" alt="MSN" title="MSN" />' ; ?></td>
                <td><input name="msn" type="text" id="msn" class="form-control inputbox" value="<?php echo $this->user_info->msn; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo '<img src="' . _AUP_IMAGE_LIVE_PATH . 'skype.gif" border="0" alt="skype" title="skype" />' ; ?></td>
                <td><input name="skype" type="text" id="skype" class="form-control inputbox" value="<?php echo $this->user_info->skype; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo '<img src="' . _AUP_IMAGE_LIVE_PATH . 'gtalk.gif" border="0" alt="gtalk" title="gtalk" />' ; ?></td>
                <td><input name="gtalk" type="text" id="gtalk" class="form-control inputbox" value="<?php echo $this->user_info->gtalk; ?>" size="35" /></td>
		      </tr>
			  <tr>
                <td><?php echo '<img src="' . _AUP_IMAGE_LIVE_PATH . 'xfire.gif" border="0" alt="xfire" title="xfire" />' ; ?></td>
                <td><input name="xfire" type="text" id="xfire" class="form-control inputbox" value="<?php echo $this->user_info->xfire; ?>" size="35" /></td>
		      </tr>
			  <?php } ?>
			  <tr> 
			...
			<div class="col-sm-6 col-md-6 col-lg-6 col-xs-6 form-actions">
				<button type="submit" class="col-sm-12 col-md-12 col-lg-12 col-xs-12 btn btn-primary validate"><?php echo JText::_('AUP_SAVE_CHANGE');?></button>
			</div>
			<div class="col-sm-6 col-md-6 col-lg-6 col-xs-6 form-actions">
				<a class="btn btn-default col-sm-12 col-md-12 col-lg-12 col-xs-12" href="<?php echo JRoute::_('');?>" title="<?php echo JText::_('JCANCEL');?>"><?php echo JText::_('JCANCEL');?></a>
			</div>
