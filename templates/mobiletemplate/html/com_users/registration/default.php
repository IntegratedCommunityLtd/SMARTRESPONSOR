...
<div id="page" class="page">
	...
	<div class="col-md-8 text-center">
		<form id="member-registration" role="form" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate" enctype="multipart/form-data" data-toggle="validator">
