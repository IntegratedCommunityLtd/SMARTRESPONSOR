    ...
    <div class="login-greeting">
		...
		<ul class="ul-jlslogin">
			<?php	if ($params->get('slogin_link_auch_edit', 1) == 1) {?>
				<li><a href="<?php echo JRoute::_('editprofile'); ?>"><?php echo JText::_('MOD_SLOGIN_EDIT_YOUR_PROFILE'); ?></a></li>
			<?php }	?>
...
<div class="signform form-group">
	<div class="input-group signform">	
		<label for="modlgn-username" class="sr-only"><?php echo JText::_('MOD_SLOGIN_VALUE_USERNAME') ?></label>
			<div class="input-group-addon joms-icon-user-male">
				<span class="label label-info icon-user" title="<?php echo JText::_('MOD_SLOGIN_VALUE_USERNAME') ?>"></span>
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>" style="float:right;">
			<?php echo JText::_('MOD_SLOGIN_FORGOT_YOUR_USERNAME'); ?></a>
			</div>
		<input id="modlgn-username" type="text" name="username" class="input-group" />
	...
	<div class="input-group signform">
		<label for="modlgn-passwd" class="sr-only"><?php echo JText::_('JGLOBAL_PASSWORD') ?></label>
			<div class="input-group-addon joms-icon-uniE622">
				<span class="label label-info icon-lock" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>"></span>
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=reset'); ?>" style="float:right;">
			<?php echo JText::_('MOD_SLOGIN_FORGOT_YOUR_PASSWORD'); ?></a>
			</div>
		<input id="modlgn-passwd" type="password" name="password" class="input-group" />
	<label for="modlgn-remember" class="input-group-addon" style="padding:0px 0px 0px 7px;"><?php echo JText::_('MOD_SLOGIN_REMEMBER_ME') ?>
		<input id="modlgn-remember" type="checkbox" name="remember" class="input-group" value="yes"/>
		<input type="submit" name="Submit" class="btn btn-primary" value="<?php echo JText::_('JLOGIN') ?>" /></label>		
	</div>
