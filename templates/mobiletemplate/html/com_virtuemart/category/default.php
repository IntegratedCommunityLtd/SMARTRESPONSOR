...
*/			
			?>
					<a href="<?php echo JRoute::_($product->link.$ItemidStr); ?>" title="<?php echo $product->product_name; ?>" class="btn btn-default"><span class="glyphicon glyphicon-info-sign"></span><span class="hidden-md"> <?php echo vmText::_ ( 'COM_VIRTUEMART_PRODUCT_DETAILS' ); ?></span></a>
