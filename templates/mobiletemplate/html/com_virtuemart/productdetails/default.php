...
<div class="productdetails-view productdetails">
	...
	<div id="publication" class="carousel slide" data-ride="carousel" data-interval="3000">
...
<?php
								...
								?>
<div class="joms-focus" style="z-index: 2;">							
				...
				<div id="seurce">
					<div class="btn-group-vertical componenta">
							...
							<?php
								...
								echo shopFunctionsF::renderVmSubLayout('customfields',array('product'=>$this->product,'position'=>'type'));								
							?>
