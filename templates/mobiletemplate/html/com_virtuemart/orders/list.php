...
if (count($this->orderlist) == 0) {
 ...
 ?>
<div id="editcell">
	<table class="table table-striped table-hover table-condensed adminlist">
	<thead>
	<tr>
		<th>
	...
	<?php
		...
		foreach ($this->orderlist as $row) {
			$editlink = JRoute::_('index.php?com_ajax&option=com_virtuemart&view=orders&layout=details&order_number=' . $row->order_number, FALSE);
			?>
