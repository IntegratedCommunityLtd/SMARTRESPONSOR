...
$virtuemart_vendor_id = $this->virtuemart_vendor_id;
	...
	if($multicat)
	{
		echo '<select id="formcat" class="form-control chosen" required="required" aria-required="true" ';
...
///////////////////////////////// end Category select field
	...
	if($enableweight){
				...
				elseif(count($weightunits)>1){
					echo ' <div class="form-group">';
					echo '<select id="formweightunit" name="formweightunit" class="form-control chosen" onchange="this.style.backgroundColor = \'\';" >';
		...
		foreach ($this->core_custom_fields as $core_custom_field)
		{
			...
			switch($core_custom_field->field_type){
				...
				if($core_custom_field->is_list)
				{
					...
					echo '<dt>';				
					echo '<dt>';
					echo '<dd><select class="form-control chosen" name="corecustomfield_'.$i.'" id="corecustomfield_'.$i.'">';
				...
				case "V": // cart variant
					if(!$core_custom_field->is_list)
						...
						if(count($exploded_cartvar)>1){
							echo '<dt>';				
							echo '<dt>';	
							echo '<dd><select name="corecustomfield_'.$i.'" id="corecustomfield_'.$i.'" class="form-control chosen" >';
