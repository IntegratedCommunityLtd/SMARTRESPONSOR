...
//if($allowed){
 ...
 <form method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="vmv-form form-validate" rol="form" action="<?php echo JRoute::_('index.php?option=com_vmvendor&view=editprofile&Itemid='.$app->input->get('Itemid') ) ?>" >
