...
?>
    ...
    <div class="joms-tab__bar">
        <a class="btn btn-primary joms-profile--information" href="#joms-profile--information"><?php echo JText::_('COM_COMMUNITY_PROFILE_SETTING_INFO'); ?></a>
        <a class="btn btn-primary joms-profile--account" href="#joms-profile--account"><?php echo JText::_('COM_COMMUNITY_PROFILE_SETTING_ACCOUNT'); ?></a>
    </div>
    ...
    <div id="joms-profile--information" class="joms-tab__content" style="display:none;">
        ...
        <form name="jsform-profile-edit" id="frmSaveProfile" role="form" action="<?php echo CRoute::getURI(); ?>" method="POST"
              class="form-validate js-form">
            <?php
    ...
    <div id="joms-profile--account" class="joms-tab__content" style="display:none;">
        ...
        <form name="jsform-profile-edit" id="frmSaveDetailProfile" action="<?php echo CRoute::getURI(); ?>"
              method="POST" class="form-validate js-form" onsubmit="return joms_validate_form( this );">
...
?>
            ...
            <div class="joms-form__group">
                ...
                <?php echo JHTML::_('form.token'); ?>				<?php //оригинальный сласс кнопки "joms-button--primary joms-button--full-small"?>
