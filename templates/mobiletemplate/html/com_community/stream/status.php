...
<div class="joms-stream__body">
    ...
    <div data-type="stream-editor" class="cStream-Respond" style="display:none">
        ...
        <div style="text-align:right;">
            <button class="btn btn-default btn-sm joms-button--neutral joms-button--small" onclick="joms.view.stream.cancel('<?php echo $activity->get('id'); ?>');"><?php echo JText::_('COM_COMMUNITY_CANCEL'); ?></button>&nbsp;
            <button class="btn btn-primary btn-sm joms-button--primary joms-button--small" onclick="joms.view.stream.save('<?php echo $activity->get('id'); ?>', this);"><?php echo JText::_('COM_COMMUNITY_SAVE'); ?></button>
        </div>
    </div>
            ...
            <?php if($headMetaParams->get('type') == 'video'){
                ...
                <div class="joms-media--album">
                    <?php if ($headMetaParams->get('image')) { ?>
                        <div class="joms-media__thumbnail">
                            <a <?php echo $href; ?>>
                                <img src="<?php echo $headMetaParams->get('image'); ?>" alt="" >
                            </a>
                        </div>
                    <?php } ?>
                    <div class="joms-media__body">
                        ...
                        <p class="joms-media__desc">
                            <?php echo CStringHelper::trim_words($headMetaParams->get('description')); ?>
                        </p>
                    </div>
                </div>
            <?php } ?>
