...
<div class="joms-popup__content">
    <div class="joms-tab__bar">
        <a href="#joms-tab--photo"><?php echo JText::_('COM_COMMUNITY_PHOTOS_ALBUMS_LABEL'); ?></a>
    ...
    <div id="joms-tab--cover" class="joms-tab__content">
        ...
        <form method="POST" enctype="multipart/form-data"
            action="<?php echo CRoute::_('index.php?option=com_community&view=photos&task=ajaxCoverUpload&type=' . $type . '&parentId=' . $parentId); ?>">
