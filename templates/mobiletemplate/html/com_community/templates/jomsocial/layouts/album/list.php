...
<div class="joms-page">
    ...
    <?php if ($groupId > 0 && $my->authorise('community.create', 'groups.photos.' . $groupId)) { ?>
        <button class="joms-button--add-on-page joms-button--primary joms-button--small"
                onclick="joms.api.photoUpload('', '<?php echo $groupId; ?>');"><?php echo JText::_('COM_COMMUNITY_GROUP_PHOTOS_UPLOAD_PHOTOS') ?></button>
    <?php } else {
        if ($isOwner && $my->id) { ?>
            <button class="joms-button--add-on-page joms-button--primary joms-button--small"
    ...
    <div class="joms-tab__content">
        <?php if ($type != PHOTOS_GROUP_TYPE) { ?>
            <select class="joms-select" onchange="joms_change_filter(this.value);">
                ...
                <option value="featured_only" <?php if($sortBy=='featured_only') echo "selected='selected'";?>><?php echo JText::_('COM_COMMUNITY_FEATURED_ONLY'); ?></option>
                <option value="featured" <?php if($sortBy=='featured') echo "selected='selected'";?>><?php echo JText::_('COM_COMMUNITY_FEATURED'); ?></option>
                <?php } ?>
            </select>
        <?php } ?>
                            ...
                            <div class="joms-gallery__thumbnail" >
                                ...
                                <a class="joms-relative joms-block"
                                    ...
                                    <img src="<?php echo $album->getCoverThumbURI(); ?>"
                                         ...
                                         data="album_prop_<?php echo rand(0, 200) . '_' . $album->id; ?>">
                                </a>

                            <?php if ($album->isOwner || $isSuperAdmin) { ?>
                                <div class="joms-gallery__options">
                                    ...
                                    <ul class="joms-dropdown">
                                        <?php if ($album->isOwner && !$isAvatarAlbum) { ?>
                                            <li>
                                                <a href="<?php echo $album->editLink; ?>"><?php echo JText::_('COM_COMMUNITY_PHOTOS_EDIT'); ?></a>
                                            </li>

                                            <li><a href="javascript:"
                                                   onclick="joms.api.photoUpload('<?php echo $album->id; ?>');"><?php echo JText::_('COM_COMMUNITY_PHOTOS_UPLOAD'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <li><a href="javascript:"
