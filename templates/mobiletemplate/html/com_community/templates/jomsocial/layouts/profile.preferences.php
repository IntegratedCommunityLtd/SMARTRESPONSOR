        ...
        <div class="joms-subnav__menu">
            <a data-ui-object="joms-dropdown-button" class="joms-button--neutral joms-button--full" href="javascript:">
                ...
                <svg class="joms-icon" viewBox="0 0 16 16">
                    <use xlink:href="#joms-icon-arrow-down" class="joms-icon--svg-fixed"/>
                </svg>
            </a>
            ...
            <ul class="nav nav-tabs hidden-xs">
                <li class="active"><a href="#general" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_PROFILE_PREFERENCES_GENERAL'); ?></a></li>
                <li><a href="#privacy" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_PROFILE_PREFERENCES_PRIVACY'); ?></a></li>
                <li><a href="#email" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_PROFILE_PREFERENCES_EMAIL'); ?></a></li>
                <li><a href="#ignorelist" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_PROFILE_PREFERENCES_BLOCKIGNORELIST'); ?></a></li>
            </ul>
