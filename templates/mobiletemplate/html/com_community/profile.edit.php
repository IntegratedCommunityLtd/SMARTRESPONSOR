				...
				<form name="jsform-profile-edit" id="frmSaveDetailProfile" action="<?php echo CRoute::getURI(); ?>" method="POST" class="cForm community-form-validate">
					...
					/*
						...
						<li>
							...
							<div class="form-field">
                                ...
                                if (JComponentHelper::getParams('com_users')->get('change_login_name')){ ?>
                                    <input class="input text" type="text" id="name" name="username" value="<?php echo $this->escape($user->get('username'));?>" />
                                <?php } else { ?>
						...
						<li>
							...
							<div class="form-field">
								<input class="input text" type="text" id="name" name="name" value="<?php echo $this->escape($user->get('name'));?>" />
							</div>
						</li>
						<?php } ?>
						<!-- email -->
						<li>
							...
							<div class="form-field">
								<input type="text" class="input text" id="jsemail" name="jsemail" value="<?php echo $this->escape( $user->get('email') ); ?>" />
						...
						<li>
							...
							<div class="form-field">
								<input id="jspassword" name="jspassword" class="input password" type="password" value="" />
						...
						<li>
							...
							<div class="form-field">
								<input id="jspassword2" name="jspassword2" class="input password" type="password" value="" />
