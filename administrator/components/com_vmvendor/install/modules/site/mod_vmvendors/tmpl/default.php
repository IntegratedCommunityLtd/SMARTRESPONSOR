...
if (count($vendors)>0){
	...
	foreach ($vendors as $vendor){
		...
		<a href="'.$vendor_url.'" ><span>'.ucfirst($vendor->vendor_name).'</span>';
		...
		if($show_rating)
		{
			...
			echo '<div class="vendor_rating '.$tipclass.'" title="'.$stars.'/'.$rating_stars.'" ><a href="'.$vendor_url.'" >';
			for ($i=1;$i<= $stars;$i++)
			{
