...
<a href="https://www.nordmograph.com/extensions/index.php?option=com_kunena&view=category&catid=22&Itemid=108" >VMVendor Support Forum</a>  
| <a href="https://www.nordmograph.com/extensions/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=56&virtuemart_category_id=3&Itemid=58" >VM2tags</a>  
| <a href="https://www.nordmograph.com/extensions/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=15&virtuemart_category_id=4&Itemid=58" >VM2share</a>
| <a href="https://www.nordmograph.com/extensions/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=62&virtuemart_category_id=4&Itemid=58" >VM Wishlists</a> </div>';

$f = 'vmvendor.xml';
$xml = simplexml_load_file(JPATH_COMPONENT.'/'.$f);

echo '<div style="text-align:center;">VMVendor Component <a href="https://www.nordmograph.com/extensions/updateserver/changelog/com_'.$f.'" target="_blank">Version '.$xml->version.'</a> - Copyright <a href="https://www.nordmograph.com/extensions" >Nordmograph.com/extensions</a> - 2010-'.date('Y').' © All rights reserved.</div>';