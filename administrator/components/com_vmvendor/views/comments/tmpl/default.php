...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_vmvendor&task=comments.saveOrderAjax&tmpl=component';
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.state', $listDirn, $listOrder); ?>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'XXX_INTERNAL_NAME_XXX.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_vmvendor&task=comment.edit&id='.(int) $item->id); ?>">
