...
class VmvendorViewComments extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        VmvendorHelper::addSubmenu('comments');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_VMVENDOR_TITLE_COMMENTS'), 'comments.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_vmvendor&view=comments');
	...
	protected function getSortFields()
	{
		...
		'a.vendor_userid' => JText::_('COM_VMVENDOR_COMMENTS_VENDOR_USERID'),
		'a.title' => JText::_('COM_VMVENDOR_COMMENTS_TITLE'),
		'a.lang' => JText::_('COM_VMVENDOR_COMMENTS_LANG'),
		'a.created_on' => JText::_('COM_VMVENDOR_COMMENTS_CREATED_ON'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.reports' => JText::_('COM_VMVENDOR_COMMENTS_REPORTS'),
