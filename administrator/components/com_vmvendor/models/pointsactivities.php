 ...
 */
class VmvendorModelPointsactivities extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.datareference', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__vmvendor_userpoints_details` AS a');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.datareference LIKE '.$search.' )');
            }
        }
